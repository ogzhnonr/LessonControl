...
<!-- <a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a> -->
  <ul>
    ...
    <li class="active"><a href="listTaskMilestoneEA"><i class="icon icon-list"></i> <span>EA Deneme Listesi</span></a> </li>
...
<!--breadcrumbs-->
  <div id="content-header">
    <div id="breadcrumb"> <a href="listTaskMilestoneEA" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> EA Deneme Listesi</a></div>
  </div>
<!--End-breadcrumbs-->
        ...
        <div class="widget-box">
          <div class="widget-title">
            <ul class="nav nav-tabs">
              <li class="active"><a data-toggle="tab" href="#tab2">Eşit Ağırlık Liste</a></li>
            </ul>
          </div>
          <div class="widget-content tab-content">
            <div id="tab2" class="tab-pane active">
            	<div class="panel panel-default">
					...
					<tbody>
						<c:forEach items="${taskMilestonesEA}" var="taskMilestone">
							<tr>
